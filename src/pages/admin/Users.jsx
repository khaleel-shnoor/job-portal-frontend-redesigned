                                ...
                                user.recent_applications.map((app) => (
                                  ...
                                  >
                                    <Link
                                      ...
                                      className="font-semibold text-[var(--color-primary)] hover:text-[var(--color-accent)] hover:underline transition-colors"
                                    >
                                      {app.job_title}
                                    </Link>
                                    <span className="text-xs font-bold px-2 py-1 rounded bg-[var(--bg-secondary)] text-[var(--color-accent)] uppercase tracking-wider">
                                      {app.status}
                                    </span>
                                  </li>
                                ))
